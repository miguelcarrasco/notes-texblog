...
como se llegó a estas fórmulas.
...
Dado un conjunto de $n$ pares de datos $(y_1,x_1),(y_2,x_2),(y_3,x_3),...,(y_n,x_n)$ que se presupone se ajustan a
...
de [optimización convexa](https://en.wikipedia.org/w/index.php?title=Convex_optimization&oldid=1000262013). Por el
momento tendremos que "creer ciegamente" en este hecho, pero espero poder publicar la demostración en otra ocasión.
